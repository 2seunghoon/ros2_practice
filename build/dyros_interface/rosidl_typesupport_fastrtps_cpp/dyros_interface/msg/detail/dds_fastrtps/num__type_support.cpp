...
#include "dyros_interface/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const dyros_interface::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dyros_interface::msg::Num *>(
    untyped_ros_message);
...
{
  return &dyros_interface::msg::typesupport_fastrtps_cpp::_Num__handle;
}
