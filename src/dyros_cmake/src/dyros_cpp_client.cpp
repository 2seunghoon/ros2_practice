...
rclcpp::Client<dyros_interface::srv::AddThreeInts>::SharedPtr client =
node->create_client<dyros_interface::srv::AddThreeInts>("add_three_ints");
auto request = std::make_shared<dyros_interface::srv::AddThreeInts::Request>();
